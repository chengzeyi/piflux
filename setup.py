...
def my_local_scheme(version):
    ...
    local_version = os.getenv("PIFLUX_BUILD_LOCAL_VERSION")
...
setup(
    name="piflux",
    use_scm_version={"write_to": path.join("src", "piflux", "_version.py"), "local_scheme": my_local_scheme},
    package_dir={
        "": "src",
    },
    ...
    extras_require={
        ...
        "all": [],
        # dev dependencies. Install them by `pip3 install 'piflux[dev]'`
        "dev": [
            "pre-commit",
            "pytest",
        ],
